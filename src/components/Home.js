    ...
    <div className="page-container">
      ...
      <div className="hero-container">
        ...
        <div className={`content-wrapper ${loaded ? 'visible' : ''}`}>
          <div className="hero-content">
            <h1 className="hero-title">Your Data, <span className="gradient-text">Elevated</span></h1>
            <p className="hero-subtitle">Secure, intelligent cloud solutions for modern businesses</p>
      ...
      <div className="company-section">
        <div className="section-header">
          <h2>Why Choose <span className="gradient-text">Cloud Deck</span></h2>
        ...
        <div className="testimonial-section">
          <div className="testimonial">
            ...
            <p>Cloud Deck transformed our infrastructure overnight. We've seen a 40% reduction in costs and 200% improvement in performance.</p>
          ...
          <div className="testimonial">
            <div className="quote-mark">"</div>
            <p>The migration was seamless, and the ongoing support has been exceptional. Cloud Deck understands enterprise needs like no other provider.</p>
            <div className="testimonial-author">
              <div className="author-avatar"></div>
              <div className="author-info">
                <h4>Michael Chen</h4>
